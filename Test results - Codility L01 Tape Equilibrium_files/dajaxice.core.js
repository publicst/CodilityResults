...
var Dajaxice = {
    ...
    task_idea_submit: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.taskideas.task_idea_submit', 'POST', callback_function, argv, custom_settings);
    }
    ...
    change_account: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.backoffice.change_account', 'POST', callback_function, argv, custom_settings);
    }
